...
## 2. Pick the announcement channel (optional)

If a notification connection exists, ask which channel or recipient release announcements go to, and record it. If the user does not want announcements, record "no notification sink" and the announce step will be skipped during runs.

## 3. Configure the test command (optional)
