# Example run: export-contact-list

- **Target**: https://app.acme-crm.test
...
- `2-recipe/results.md`: script verdict and proposed script.
- `done/info.md`: outcome and what was learned.
